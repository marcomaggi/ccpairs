...
static ccpairs_descriptor_not_enough_items_t descriptor_not_enough_items = {
...
ccpairs_descriptor_not_enough_items_t const * const ccpairs_descriptor_not_enough_items = &descriptor_not_enough_items;

/* This struct type has no dynamic fields, so there is only one instance
   of this struct type.  We allocate it statically. */
static ccpairs_condition_not_enough_items_t const condition_not_enough_items = {
...
static ccpairs_descriptor_empty_list_t const descriptor_empty_list = {
...
ccpairs_descriptor_empty_list_t const * const ccpairs_descriptor_empty_list = &descriptor_empty_list;

/* This struct type has no dynamic fields, so there is only one instance
   of this struct type.  We allocate it statically. */
static ccpairs_condition_empty_list_t const condition_empty_list = {
...
static ccpairs_descriptor_circular_list_t descriptor_circular_list = {
  /* This field is set by the initialisation function below. */
  .descriptor.parent		= NULL,
  .descriptor.delete		= NULL,
  .descriptor.final		= NULL,
...
ccpairs_descriptor_circular_list_t const * const ccpairs_descriptor_circular_list = &descriptor_circular_list;

/* This struct type has no dynamic fields, so there is only one instance
   of this struct type.  We allocate it statically. */
static ccpairs_condition_circular_list_t const condition_circular_list = {
